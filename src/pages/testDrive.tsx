    ...
    return (
      <div className="relative w-full h-screen">
        ...
        <button
          ...
          className="fixed top-20 left-4 z-[999] flex items-center space-x-2 px-3 py-2 bg-white/90 backdrop-blur-sm hover:bg-white shadow-lg hover:shadow-xl rounded-lg transition-all duration-300 border border-gray-200 text-sm"
        >
    ...
    <div className="w-full">
      ...
      <div className="relative w-full h-screen overflow-hidden">
        ...
        <div className="relative z-20 flex items-center justify-center h-full px-4">
          <div className="text-center text-white max-w-2xl">
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold tracking-wider mb-6 md:mb-8 drop-shadow-lg leading-tight">BOOK YOUR DREAM CAR</h1>
            <p className="text-base sm:text-lg md:text-xl leading-relaxed mb-8 md:mb-12 opacity-90 drop-shadow-md max-w-lg mx-auto px-4">
      ...
      <div className="bg-gray-100 min-h-screen py-8 md:py-16">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          {/* Step 1 */}
          <div className="bg-gray-200/50 p-4 sm:p-6 md:p-8 rounded-lg mb-6 md:mb-8 relative">
            {/* Step indicator - hidden on mobile, adjusted on tablet */}
            <div className="hidden sm:block absolute left-2 md:left-4 top-1/2 transform -translate-y-1/2 -rotate-90">
              <div className="flex items-center">
                ...
                <span className="text-gray-500/40 text-3xl md:text-5xl font-bold">1</span>
              </div>
            </div>
            
            {/* Mobile step indicator */}
            <div className="sm:hidden text-center mb-4">
              <span className="text-gray-500 text-lg font-bold">STEP 1</span>
            </div>

            <div className="sm:ml-16 md:ml-28 flex items-center justify-center mb-6">
              <h2 className="text-xl md:text-2xl font-bold text-gray-800">CHOOSE YOUR CAR</h2>
            </div>
            <div className="sm:ml-16 md:ml-28 flex justify-center">
              <button className="px-6 md:px-8 py-2 md:py-3 text-sm font-semibold rounded-md bg-black text-white cursor-default">RIDDARA</button>
            </div>
            <div className="sm:ml-16 md:ml-28 mt-8 md:mt-12">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {cars.map((car) => (
                  ...
                  >
                    <div className="mb-4">
                      <img src={car.image} alt={car.name} className="w-full h-20 md:h-24 object-contain" />
                    </div>
                    <h4 className="font-bold text-gray-800 text-center text-base md:text-lg mb-2">{car.name}</h4>
          ...
          {selectedCar && (
            <div className="bg-gray-200/50 p-4 sm:p-6 md:p-8 rounded-lg mb-6 md:mb-8 relative">
              ...
              <div className="hidden sm:block absolute left-2 md:left-4 top-1/2 transform -translate-y-1/2 -rotate-90">
                <div className="flex items-center">
                  <span className="text-gray-500/40 text-lg md:text-2xl font-bold tracking-widest mr-1 md:mr-2">STEP</span>
                  <span className="text-gray-500/40 text-3xl md:text-5xl font-bold">2</span>
                </div>
              </div>
              
              {/* Mobile step indicator */}
              <div className="sm:hidden text-center mb-4">
                <span className="text-gray-500 text-lg font-bold">STEP 2</span>
              </div>
                    ...
                    <div className="flex-1 mx-2 md:mx-4 overflow-hidden">
                      ...
                      >
                        {getAvailableExteriorColors().map((color) => (
                          ...
                          >
                            <div className="mb-2 md:mb-3 h-16 sm:h-20 md:h-24 flex items-center justify-center overflow-hidden rounded">
          ...
          {selectedCar && selectedExteriorColor && (
            <div className="bg-gray-200/50 p-4 sm:p-6 md:p-8 rounded-lg mb-6 md:mb-8 relative">
              ...
              {/* Mobile step indicator */}
              <div className="sm:hidden text-center mb-4">
                <span className="text-gray-500 text-lg font-bold">STEP 2 - INTERIOR</span>
              </div>
                  ...
                  {getAvailableInteriorColors().map((color) => (
                    ...
                    >
                      <div className="mb-4 overflow-hidden rounded">
                        <img src={color.image} alt={color.name} className="w-full h-24 md:h-32 object-contain" />
                      </div>
                      <p className="text-gray-800 text-center font-semibold text-sm md:text-base">{color.name}</p>
                    </div>
                  ))}
                </div>
              </div>
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-6 md:py-8">
        ...
        <button 
          ...
          className="flex items-center text-gray-600 hover:text-gray-800 mb-6 md:mb-8 transition-colors"
        >
        ...
        <div className="bg-white rounded-lg shadow-sm overflow-hidden">
          <div className="p-4 md:p-8">
            <h1 className="text-2xl md:text-3xl font-light text-gray-800 mb-6 md:mb-8">Review Your Order</h1>

            {/* Vehicle Overview */}
            <div className="flex flex-col lg:flex-row items-center justify-between mb-6 md:mb-8">
              <div className="w-full lg:w-1/2 mb-6 lg:mb-0">
                <h2 className="text-lg md:text-xl text-gray-700 mb-4 md:mb-6 text-center lg:text-left">
                  {orderData.selectedBrand} {selectedCarDetails?.name || "Selected Vehicle"}
                </h2>

                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 md:gap-8 text-sm">
                  <div className="text-center">
                    <div className="text-gray-500 mb-1">UP TO</div>
                    <div className="text-lg md:text-xl font-semibold text-gray-800">632 Km*</div>
                    <div className="text-gray-500">Driving Range</div>
                  </div>
                  <div className="text-center">
                    <div className="text-gray-500 mb-1">AS FAST AS</div>
                    <div className="text-lg md:text-xl font-semibold text-gray-800">4.5 sec*</div>
                    <div className="text-gray-500">To Reach 100</div>
                  </div>
                  <div className="text-center">
                    <div className="text-gray-500 mb-1">UP TO</div>
                    <div className="text-lg md:text-xl font-semibold text-gray-800">86.56 KWh*</div>
            ...
            <button className="flex items-center px-4 py-2 border border-gray-300 rounded hover:bg-gray-50 transition-colors mb-6 md:mb-8 w-full sm:w-auto justify-center sm:justify-start">
          ...
          <div className="border-t border-gray-200 p-4 md:p-8">
            <h3 className="text-lg md:text-xl text-gray-700 mb-6">Order Details</h3>

            <div className="space-y-4 md:space-y-6">
              {/* Order Details - Mobile Responsive */}
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between py-3 md:py-4 border-b border-gray-100">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between py-3 md:py-4 border-b border-gray-100">
                <span className="text-gray-600 mb-1 sm:mb-0">Customer Name</span>
                <span className="text-gray-800 text-right">{orderData.formData.firstName} {orderData.formData.lastName}</span>
              </div>

              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between py-3 md:py-4 border-b border-gray-100">
                <span className="text-gray-600 mb-1 sm:mb-0">Father/Husband Name</span>
                <span className="text-gray-800 text-right">{orderData.formData.fatherHusbandName || "Not provided"}</span>
              </div>

              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between py-3 md:py-4 border-b border-gray-100">
                <span className="text-gray-600 mb-1 sm:mb-0">Email Address</span>
                <span className="text-gray-800 text-right break-words">{orderData.formData.email || "Not provided"}</span>
              </div>

              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between py-3 md:py-4 border-b border-gray-100">
                <span className="text-gray-600 mb-1 sm:mb-0">Primary Phone</span>
                <span className="text-gray-800 text-right">+92 {orderData.formData.primaryPhone}</span>
              </div>

              {orderData.formData.secondaryPhone && (
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between py-3 md:py-4 border-b border-gray-100">
                  <span className="text-gray-600 mb-1 sm:mb-0">Secondary Phone</span>
                  <span className="text-gray-800 text-right">+92 {orderData.formData.secondaryPhone}</span>
                </div>
              )}

              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between py-3 md:py-4 border-b border-gray-100">
                <span className="text-gray-600 mb-1 sm:mb-0">Location</span>
                <span className="text-gray-800 text-right">{orderData.formData.city}, {orderData.formData.state}</span>
              </div>

              <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between py-3 md:py-4 border-b border-gray-100">
                <span className="text-gray-600 mb-1 sm:mb-0">Address as per CNIC</span>
                <span className="text-gray-800 text-right sm:max-w-xs break-words">{orderData.formData.addressCNIC || "Not provided"}</span>
              </div>

              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between py-3 md:py-4 border-b border-gray-100">
                <span className="text-gray-600 mb-1 sm:mb-0">Individual/Corporate</span>
                <span className="text-gray-800 text-right">{orderData.formData.individualCorporate || "Not provided"}</span>
              </div>

              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between py-3 md:py-4 border-b border-gray-100">
                <span className="text-gray-600 mb-1 sm:mb-0">CNIC</span>
                <span className="text-gray-800 text-right">{orderData.formData.cnic || "Not provided"}</span>
              </div>

              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between py-3 md:py-4 border-b border-gray-100">
                <span className="text-gray-600 mb-1 sm:mb-0">CNIC Images</span>
                <span className="text-gray-800 text-right text-sm">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between py-3 md:py-4 border-b border-gray-100">
                <span className="text-gray-600 mb-1 sm:mb-0">Selected Advance Payment</span>
                <span className="text-gray-800 font-semibold text-right">{advancePaymentPercentage}%</span>
              </div>

              {orderData.formData.comments && (
                <div className="flex flex-col py-3 md:py-4 border-b border-gray-100">
                  <span className="text-gray-600 mb-2">Comments</span>
                  <span className="text-gray-800 text-sm bg-gray-50 p-3 rounded break-words">{orderData.formData.comments}</span>
                </div>
              )}
            </div>

            {/* Pricing Summary - Mobile Responsive */}
            ...
            <div className="flex flex-col space-y-4 mt-6 md:mt-8 border-t border-gray-200 pt-6">
              {/* Upload Pay Order - Full width on mobile */}
              <div className="flex flex-col sm:flex-row sm:items-center gap-3">
                <button 
                  onClick={handleUploadClick} 
                  className="flex items-center justify-center px-4 py-2 border border-gray-300 rounded hover:bg-gray-50 transition-colors w-full sm:w-auto"
                >
                  <Upload className="w-4 h-4 mr-2" />
                  Upload Pay order Slip
                </button>
                {uploadedFile && (
                  <span className="text-sm text-gray-600 truncate px-2 text-center sm:text-left">
                    {uploadedFile.name}
                  </span>
                )}
                <input
              ...
              {/* Save & Submit Button - Full width on mobile */}
